...
public class VoteService {
    ...
    public void vote(
        ...
        int participantCount =
                participantMapper.countParticipantByIdAndMeeting(
                        participantId,
                        meetingId
                );
        ...
        // 8. 같은 후보를 또 선택
        if (existingVote.getCandidateId()
                .equals(request.getCandidateId())) {
    ...
    public List<CandidateVoteResult> getVoteResults(
        ...
        return voteMapper.selectVoteResults(meetingId);
    }
